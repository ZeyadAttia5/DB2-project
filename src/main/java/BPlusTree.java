...
public class BPlusTree {
        ...
        Comparator<DictionaryPair> c = new Comparator<DictionaryPair>() {
            ...
            public int compare(DictionaryPair o1, DictionaryPair o2) {
                if (o1 == null && o2 == null) {
                    ...
                    return -1; // Null key comes before non-null key
                } else if (o2 == null) {
                    return 1; // Non-null key comes before null key
                }
                if (o1.key instanceof Integer && o2.key instanceof Integer) {
                    ...
                    return a.compareTo(b);
                } else if (o1.key instanceof String && o2.key instanceof String) {
    ...
    private LeafNode findLeafNode(Object key) {
        ...
        for (i = 0; i < this.root.degree - 1; i++) {
            if(key.getClass().equals(Integer.class)){
                if ((Integer) key < (Integer)keys[i]) { break; }
            }
            if(key.getClass().equals(Double.class)){
                if ((Double) key < (Double)keys[i]) { break; }
            }
            if(key.getClass().equals(String.class)){
                if (((String) key).compareTo((String) keys[i]) < 0) { break; }
            }
            ...
            if (dpIndex < 0) {
                ...
                if (ln.isDeficient()) {
                    ...
                    if (ln.leftSibling != null &&
                        ...
                        if(borrowedDP.key.getClass().equals(Integer.class)){
                            if (!((Integer) borrowedDP.key >= (Integer) parent.keys[pointerIndex - 1])) {
                                parent.keys[pointerIndex - 1] = (Integer) ln.dictionary[0].key;
                            }
                        }
                        if(borrowedDP.key.getClass().equals(Double.class)){
                            if (!((Double) borrowedDP.key >= (Double) parent.keys[pointerIndex - 1])) {
                                parent.keys[pointerIndex - 1] = (Double) ln.dictionary[0].key;
                            }
                        }
                        if(borrowedDP.key.getClass().equals(String.class)){
                            if (((String) borrowedDP.key).compareTo((String) parent.keys[pointerIndex - 1]) < 0) {
                                parent.keys[pointerIndex - 1] = (String) ln.dictionary[0].key;
                            }
                        }
                        ...
                        int pointerIndex = findIndexOfPointer(parent.childPointers, ln);
                        if(borrowedDP.key.getClass().equals(Integer.class)){
                            if (!((Integer)borrowedDP.key < (Integer) parent.keys[pointerIndex])) {
                                parent.keys[pointerIndex] = sibling.dictionary[0].key;
                            }
                        }
                        if(borrowedDP.key.getClass().equals(Double.class)){
                            if (!((Double)borrowedDP.key < (Double) parent.keys[pointerIndex])) {
                                parent.keys[pointerIndex] = sibling.dictionary[0].key;
                            }
                        }
                        if(borrowedDP.key.getClass().equals(String.class)){
                            if (((String) borrowedDP.key).compareTo((String) parent.keys[pointerIndex]) >= 0) {
                                parent.keys[pointerIndex] = sibling.dictionary[0].key;
                            }
                        }
     ...
     */
    public void insert(Object key, Page value){
        if (isEmpty()) {
     ...
     */
    public ArrayList<Page> search(Object lowerBound, Object upperBound) {

        // Instantiate Double array to hold values
        ArrayList<Page> values = new ArrayList<Page>();
...
//                System.arraycopy(nonNullPairs, 0, this.dictionary, 0, nonNullPairs.length);
    ...
    public class DictionaryPair implements Comparable<DictionaryPair> {
         ...
         */
        public DictionaryPair(Object key, Page value) {
            this.key = key;
            this.value = value;
        }
        ...
        public int compareTo(DictionaryPair o) {
            if (key.getClass().equals(Integer.class)) {
                Integer thisKey = (Integer) key;
                Integer otherKey = (Integer) o.key;
                return thisKey.compareTo(otherKey);
            } else if (key.getClass().equals(String.class)) {
                String thisKey = (String) key;
                String otherKey = (String) o.key;
                return thisKey.compareTo(otherKey);
            } else if (key.getClass().equals(Double.class)) {
                Double thisKey = (Double) key;
                Double otherKey = (Double) o.key;
                return thisKey.compareTo(otherKey);
            } else {
